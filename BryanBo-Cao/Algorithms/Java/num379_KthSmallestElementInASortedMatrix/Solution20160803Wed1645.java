    ...
    public int kthSmallest(int[][] matrix, int k) {
        if (matrix != null && matrix.length > 0 && matrix[0].length > 0) {
        	...
        	while (iR < r && jR < c && iD < r && jD < c) {
        		...
        		System.out.println("i: " + i + " next: " + matrix[minIs[0]][minIs[1]] + " direction: " + direction);
        		if (i++ == k) return matrix[minIs[0]][minIs[1]];
        		if (jR >= c && matrix[iR + 1][jR] <= matrix[iD][jD]) jR++;
        		if (iD >= r && matrix[iD][jD + 1] <= matrix[iR][jR]) iD++;
        		switch (direction) {
        		case 0: jR++; break;
        		case 1: iR++; break;
        		case 2: jD++; break;
...
//20160803Wed16:45 WrongAnswer @github.com/BryanBo-Cao,hackerrank.com/bryanbocao,leetcode.com/bryanbocao-0/,linkedin.com/in/bryanbocao 
